function fg_tomoSeries_dose_nr_loglog_blackThinLines(figProps, dataT, ttl, pltBurnt, pltMassLossType, pltViable, singlePlot, lgnd)
% alter vars
...
% contained damage compatible with imaging (masslossType1)
if pltViable
    idxViable = dataT(dataT.massLossType~='1');
...
%     if tsIdxs(i)
        ...
        hold on;
        loglog(x, y, ...
            dataMarker,'MarkerEdgeColor',colors(colorIdx,:),'MarkerFaceColor','w',...
